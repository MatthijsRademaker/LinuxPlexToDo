...
class ContainerConfig:
    def __init__(self,
        ...
        self.torrent_dir = media_dir + '/torrents'
    ...
    def plex(self):
        return (
            ...
            '      - ' + self.root_media_dir + '/data/media:/media\n'
    ...
    def jellyfin(self):
        return (
            ...
            '      - ' + self.root_media_dir + '/data/media:/data\n'
            '    ports:\n'
            '      - "8096:8096"\n'
            '    restart: unless-stopped\n\n'
        )
    ...
    def bazarr(self):
        return (
            ...
            '      - ' + self.root_media_dir + '/media:/media\n'
            '    ports:\n'
            '      - "6767:6767"\n'
            '    restart: unless-stopped\n\n'
        )
    ...
    def audiobookshelf(self):
        return (
            ...
            '      - ' + self.root_media_dir + '/audiobooks:/audiobooks\n'
            '      - ' + self.root_media_dir + '/podcasts:/podcasts\n'
            '      - ' + self.root_media_dir + '/audiobookshelf-metadata:/metadata\n'
            '    ports:\n'
            '      - "13378:80"\n'
            '    restart: unless-stopped\n\n'
        )
