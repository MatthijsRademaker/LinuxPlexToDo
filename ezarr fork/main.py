...
print('Where would you like to keep your container config?', end=' ')
config_dir = take_directory_input()


print('Where would you like to keep your media and torrents?', end=' ')
...
container_config = ContainerConfig(media_dir, config_dir, timezone, plex_claim=plex_claim)
...
if generate_permissions:
    permission_setup = UserGroupSetup(media_dir, config_dir)
    for service in services:
        try:
